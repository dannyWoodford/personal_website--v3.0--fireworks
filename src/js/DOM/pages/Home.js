		...
		>
			<div className='max-width-container'>
				<div className='container'>
								...
								<div className='item__border'>
									<img
										...
										src={
											...
											'/assets-by-page/home/thumbnails/flatiron-logo.png'
										}
									/>
									<img
										alt=''
										className='item__image hover-image'
										src={
											process.env.PUBLIC_URL +
											'/assets-by-page/home/gifs/flatiron-gif.gif'
										}
									/>
								</div>
							</DelayLink>
							...
							<DelayLink to={'/projects'} delay={delay} className='nav-link'>
								<div className='item__border'>
									...
									<img
										...
										src={
											process.env.PUBLIC_URL +
											'/assets-by-page/home/gifs/projects-gif.gif'
										}
									/>
								</div>
							</DelayLink>
							...
							<DelayLink to={'/blender'} delay={delay} className='nav-link'>
								<div className='item__border'>
									<img
										...
										src={
											process.env.PUBLIC_URL +
											'/assets-by-page/home/thumbnails/blender-logo.png'
										}
									/>
									<img
										alt=''
										...
										src={
											process.env.PUBLIC_URL +
											'/assets-by-page/home/gifs/blender-gif.gif'
										}
									/>
								</div>
							</DelayLink>
							...
							<DelayLink to={'/art'} delay={delay} className='nav-link'>
								<div className='item__border'>
									<img
										...
										src={
											process.env.PUBLIC_URL +
											'/assets-by-page/home/thumbnails/art-logo.png'
										}
									/>
									<img
										alt=''
										...
										src={
											process.env.PUBLIC_URL +
											'/assets-by-page/home/gifs/art-gif.gif'
										}
									/>
								</div>
							</DelayLink>
					...
					<div
						className='item item-mobile-break'
						onClick={() => props.linkToPageHandler(delay)}
					>
						<DelayLink to={'/about'} delay={delay} className='nav-link'>
							<div className='item__border'>
								<img
									...
									src={
										process.env.PUBLIC_URL +
										'/assets-by-page/home/thumbnails/about-me-logo.png'
									}
								/>
								<img
									alt=''
									...
									src={
										process.env.PUBLIC_URL +
										'/assets-by-page/home/gifs/space-gif.gif'
									}
								/>
							</div>
						</DelayLink>
					...
					<a
						href={process.env.PUBLIC_URL + '/Danny_Woodford_Resume.pdf'}
						target='_blank'
						...
						<div className='item small'>
							<div className='item__border'>
								<img
									...
									src={
										process.env.PUBLIC_URL +
										'/assets-by-page/home/thumbnails/resume-logo.png'
									}
								/>
								<img
									alt=''
					...
					>
							...
							<div className='item small' onPointerOut={() => resetTooltip()}>
								<div className='item__border'>
									<img
										...
										src={
											process.env.PUBLIC_URL +
											'/assets-by-page/home/thumbnails/phone-logo.png'
										}
									/>
									<img
										alt=''
						...
						<ReactTooltip
							id='copyPhoneNumber'
							getContent={() =>
								iconHasBeenCopied.copyPhoneNumber
					...
					>
							...
							<div className='item small' onPointerOut={() => resetTooltip()}>
								<div className='item__border'>
									<img
										...
										src={
											process.env.PUBLIC_URL +
											'/assets-by-page/home/thumbnails/email-logo.png'
										}
									/>
									<img
										alt=''
						...
						<ReactTooltip
							id='copyEMail'
							getContent={() =>
								iconHasBeenCopied.copyEMail
									? 'E-mail has been copied to clipboard!'
									: 'Copy e-mail to clipboard'
							}
						/>
					</span>
					<a
						href='https://www.linkedin.com/in/danny-woodford-54b418126/'
						target='_blank'
						rel='noopener noreferrer'
						className='display-contents'
					>
						<div className='item item-mobile-break'>
							<div className='item__border'>
								<img
									...
									src={
										process.env.PUBLIC_URL +
										'/assets-by-page/home/thumbnails/linkedIn-logo.png'
									}
								/>
								<img
									alt=''
