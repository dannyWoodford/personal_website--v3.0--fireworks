            ...
            <div className='max-width-container'>
				<div className='container'>
					...
					<div className="double-item">
						...
						<div className="item" onClick={() => props.toggleMenuHandler()}>
					...
					<div className="item large is-welcome-item">
							<div className="item__border">
								<div className="text">
									<div id='name'><p>DANNY WOODFORD</p></div>
									<div id='occupation'><p>3D Web Developer</p></div>
								</div>
								{/* <img className="item__image" draggable="false" alt="" src={process.env.PUBLIC_URL + '/images/projects/thumbnails/welcome-logo.png'}/> */}
								{/* <img alt="" className="item__image hover-image" src={process.env.PUBLIC_URL + '/gifs/projects/projects-gif.gif'} /> */}
							</div>
					</div>
					<div className="double-item">
